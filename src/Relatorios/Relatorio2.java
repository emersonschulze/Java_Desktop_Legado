 ...
 * @author altitdb
 */
public class Relatorio2 extends javax.swing.JDialog {
    ...
    public Relatorio2(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        Relatorio rel = new Relatorio("C:/Users/Emerson/Documents/NetBeansProjects/Sigfaz/src/Relatorios/ManuPasto.jasper", map);
    rel.setVisible(true);
    this.dispose();
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Relatorio2 dialog = new Relatorio2(new javax.swing.JFrame(), true);
